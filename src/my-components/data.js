const data = {
    ...
    'oocss': {
        ...
        links: [
            { link: 'https://www.alsacreations.com/article/lire/1641-Bonnes-pratiques-en-CSS--BEM-et-OOCSS.html', name: '(French) alsacreations'}
        ],
        tags: ['css', 'front']
    },
    'legacy code': {
    ...
    'arrow function': {
        text: 'An arrow function expression has a shorter syntax than a function expression and does not have its own this, arguments, super, or new.target. These function expressions are best suited for non-method functions, and they cannot be used as constructors. Syntax: () => { statements }',
        links: [
    ...
    'service worker': {
        ...
        links: [
            { link: 'https://developers.google.com/web/fundamentals/primers/service-workers/', name: 'developers.googles.com'},
            { link: 'https://developers.google.com/web/ilt/pwa/introduction-to-service-worker', name: 'developers.google.com'}
        ],
        tags: ['general', 'config']
    },
    'web app manifest': {
    ...
    'es6 import': {
        text: "import A from './A' , it only works if A has the default export: export default 42. It doesn't matter what name you use when importing. But this is a named import called A: import { A } from './A' , the name matters. There has to be export const A = 42 in A.js. A module can only have one default export, but as many named exports as you'd like. You can import them all together: import A, { myA, Something } from './A'",
        links: [
